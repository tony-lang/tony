...
export const addErrorUnless =
  <T extends StateForTraverse>(predicate: boolean, error: ErrorAnnotation) =>
 ...
 * exists.
 */
export const conditionalApply =
  <T, U>(callback: (state: T, arg: U) => T) =>
  (state: T, arg: U | undefined): T =>
    (arg && callback(state, arg)) || state
