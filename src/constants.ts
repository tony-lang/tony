...
export const TRANSFORM_PLACEHOLDER_ARGUMENT = '#internal/TRANSFORM_PLACEHOLDER_ARGUMENT'
export const TRANSFORM_IDENTIFIER_PATTERN = '#internal/TRANSFORM_IDENTIFIER_PATTERN'
